...
This failure is a little bit of ' go there and wing it'. If I pass, great!
...
So whatever you are doing, if you fail, don't be afaid. Go back and check what is wrong then fix it. Be patient.
